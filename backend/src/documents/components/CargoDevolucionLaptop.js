...
export default function CargoDevolucionLaptop({
  ...
  return h('div', {
    ...
    h('div', { className: 'relative flex h-full flex-col', style: { zIndex: 10, isolation: 'isolate' } },
      ...
      h('h1', { className: 'text-center font-bold underline uppercase text-[12pt] tracking-wide mb-6' }, 'Cargo de devolución de equipo laptop'),
      h('p', { className: 'leading-relaxed text-justify uppercase text-[11pt]' },
        'Recibí de ', h('span', { className: 'font-bold' }, empleado.nombre), ', el equipo laptop asignado con las siguientes características:'),
