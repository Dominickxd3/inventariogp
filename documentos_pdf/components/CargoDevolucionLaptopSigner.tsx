...
import CargoDevolucionLaptop from "@/components/CargoDevolucionLaptop";
...
import type { CargoDevolucionLaptopData } from "@/lib/documentos/cargo-devolucion-laptop";

type Props = {
  data: CargoDevolucionLaptopData;
  documentoId?: string;
  token?: string;
...
export default function CargoDevolucionLaptopSigner({
  data,
  documentoId,
  token,
  meta,
  ...
  const payload = useMemo(
    () => ({
      tipo: "cargo-devolucion-laptop" as const,
      ...
      empresaCorreo1: data.empresa.correo1,
      empresaCorreo2: data.empresa.correo2,
      nombre: data.empleado.nombre,
      dni: data.empleado.dni,
      responsableNombre: data.responsable.nombre,
      responsableDni: data.responsable.dni,
      ...
      firmaResponsableSrc: data.firmaResponsableSrc,
  ...
  const downloadPdf = useCallback(async () => {
    ...
    setError(null);
    try {
      const res = await fetch("/api/pdf/devolucion", {
        method: "POST",
      ...
      a.href = url;
      a.download = "cargo-devolucion-laptop.pdf";
      a.click();
        ...
        >
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
            ...
            <p className="mt-1 text-sm text-neutral-600">
              El cargo de devolución fue firmado y enviado correctamente. El
